...
%       2.1. load data
    ...
    %c_eval('eTit1 = mms.variable2ts(get_variable(feeps_obj,''mms1_epd_feeps_brst_l2_electron_top_count_rate_sensorid_1''));', ic);
    c_eval('eTit! = mms.variable2ts(get_variable(feeps_obj,''mms?_epd_feeps_brst_l2_electron_top_count_rate_sensorid_!'')); disp(''? !'')', ic,[1:5 9:12]);
    ...
    c_eval('eBit! = mms.variable2ts(get_variable(feeps_obj,''mms?_epd_feeps_brst_l2_electron_bottom_count_rate_sensorid_!'')); disp(''? !'')', ic,[1:5 9:12]);
    ...
    c_eval('ePA = mms.variable2ts(get_variable(feeps_obj,''mms?_epd_feeps_brst_l2_electron_pitch_angle'')); disp(''?'')', ic);
    c_eval('ePA = mms.variable2ts(get_variable(feeps_obj,''mms?_epd_feeps_brst_l2_electron_pitch_angle''));',ic)
    %c_eval('ePA = get_ts(feeps_obj, ''mms?_epd_feeps_brst_l2_electron_pitch_angle'');', ic);
%       2.2. tlim data
    c_eval('eTit? = eTit?.tlim(Tint); disp(''?'')', [1:5, 9:12]);   
    c_eval('eBit? = eBit?.tlim(Tint); disp(''?'')', [1:5, 9:12]);
    ePA = ePA.tlim(Tint);
...
%       4.X.
    ...
    hca=irf_panel('B'); irf_zoom(hca,'y')
