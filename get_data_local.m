...
%     'B_dmpa_dfg_srvy_l2pre','B_dmpa_dfg_srvy_l2pre',...
%     'B_bcs_dfg_srvy_l2pre','B_bcs_dfg_srvy_l2pre',...
%     'B_gsm_afg_srvy_l2pre','B_gsm_afg_srvy_l2pre',...
%     'B_gse_afg_srvy_l2pre','B_gse_afg_srvy_l2pre',...
...
vars = {'R_gse','R_gsm','V_gse','V_gsm',...
  ...
  'Flux0_edi_brst','Flux180_edi_brst',...
  'Nhplus_hpca_srvy_l2','Nheplus_hpca_srvy_l2','Nheplusplus_hpca_srvy_l2','Noplus_hpca_srvy_l2',...
  'Tshplus_hpca_srvy_l2','Tsheplus_hpca_srvy_l2','Tsheplusplus_hpca_srvy_l2','Tsoplus_hpca_srvy_l2',...
  'Vhplus_dbcs_hpca_srvy_l2','Vheplus_dbcs_hpca_srvy_l2','Vheplusplus_dbcs_hpca_srvy_l2','Voplus_dbcs_hpca_srvy_l2',...
  'Phplus_dbcs_hpca_srvy_l2','Pheplus_dbcs_hpca_srvy_l2','Pheplusplus_dbcs_hpca_srvy_l2','Poplus_dbcs_hpca_srvy_l2',...
...
switch Vr.inst
  ...
  case 'edi'    
    pref = ['mms' mmsIdS '_' Vr.inst '_flux?_' Vr.param(5:end) '_' Vr.tmmode '_' Vr.lev];
    nodes = 1:4;
    try
      dsetName = ['mms' mmsIdS '_edi_brst_l2_amb'];
      c_eval('rX? = mms.db_get_ts(dsetName,pref,Tint)',nodes);
    catch
      dsetName = ['mms' mmsIdS '_edi_brst_l2_amb-pm2'];
      c_eval('rX? = mms.db_get_ts(dsetName,pref,Tint)',nodes);      
    end
    if isempty(rX)
      irf.log('warning',...
