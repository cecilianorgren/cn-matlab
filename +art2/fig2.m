...
ind=5;
if ~exist('ind','var'); ind = 2; end % 5: nice mono also, 2: ugly mono
...
set(fig,'position',[63 234 590 463]);
nPanels = 3;
h = irf_plot(nPanels);
set(h(1),'position',[0.1900    0.5600    0.600    0.23])
set(h(2),'position',[0.1900    0.3300    0.600    0.23])
set(h(3),'position',[0.1900    0.1000    0.600    0.23])
