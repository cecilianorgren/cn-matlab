...
gseJav = (gseJ1 + gseJ4.resample(gseJ1) + gseJ3.resample(gseJ1) + gseJ4.resample(gseJ1))/4;
gseJiav = (gseJi1 + gseJi4.resample(gseJi1) + gseJi3.resample(gseJi1) + gseJi4.resample(gseJi1))/4;
gseJeav = (gseJe1 + gseJe4.resample(gseJe1) + gseJe3.resample(gseJe1) + gseJe4.resample(gseJe1))/4;
