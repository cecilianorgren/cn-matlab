...
tint_hall = irf.tint('2017-07-25T22:09:40.00Z/2017-07-25T22:10:00.00Z');
...
%% Figure: JxB momentum equation / ohms law
ic = 2;
tint_hall = irf.tint('2017-07-25T22:09:40.00Z/2017-07-25T22:10:00.00Z');
...
if 1 % B gse
  ...
  hca.YLabel.String = {'B_{GSE}','(nT)'};
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'x','y','z','|B|'},[0.98 0.9],'fontsize',fontsize);  
end 
if 0 % E gse
  isub = isub + 1;
  zoomy = [zoomy isub];
  ...
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'x','y','z'},[0.98 0.9],'fontsize',fontsize);  
end 
if 1 % E perp par gse
  isub = isub + 1;
  zoomy = [zoomy isub];
  hca = irf_panel('E gse perp par');
  set(hca,'ColorOrder',mms_colors('xyza'))  
  c_eval('irf_plot(hca,{gseE?perp.x,gseE?perp.y,gseE?perp.z,gseE?par},''comp'');',ic)
  hca.YLabel.String = {'E_{GSE}','(mV/m)'};
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'E_{\perp x}','E_{\perp y}','E_{\perp z}','E_{||}'},[0.98 0.9],'fontsize',fontsize);  
end 
if 1 % E perp par gse
  isub = isub + 1;
  zoomy = [zoomy isub];
  hca = irf_panel('E gse perp par av');
  set(hca,'ColorOrder',mms_colors('xyza'))  
  irf_plot(hca,{gseEperp.x,gseEperp.y,gseEperp.z,gseEpar},'comp');
  hca.YLabel.String = {'E_{GSE}','(mV/m)'};
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'E_{\perp x}','E_{\perp y}','E_{\perp z}','E_{||}'},[0.98 0.9],'fontsize',fontsize);  
  irf_legend(hca,{'4 sc average'},[0.02 0.08],'color','k','fontsize',fontsize);  
end 
if 0 % E dot B
  isub = isub + 1;
  zoomy = [zoomy isub];
  hca = irf_panel('E dot B');
  set(hca,'ColorOrder',mms_colors('xyza'))  
  c_eval('irf_plot(hca,{EdotB?comps.x,EdotB?comps.y,EdotB?comps.z,EdotB?},''comp'');',ic)
  hca.YLabel.String = {'E\cdot B _{GSE}','(mV/m nT)'};
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'E_xB_x','E_yB_y','E_zB_z','E\cdot B'},[0.98 0.9],'fontsize',fontsize);  
end 
if 0 % E dot B
  isub = isub + 1;
  zoomy = [zoomy isub];
  hca = irf_panel('E cross B');
  set(hca,'ColorOrder',mms_colors('xyza'))  
  c_eval('irf_plot(hca,{EcrossB?.x,EcrossB?.y,EcrossB?.z,EdotB?},''comp'');',ic)
  hca.YLabel.String = {'E\times B _{GSE}','(mV/m nT)'};
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'ExB_x','ExB_y','ExB_z','E\cdot B'},[0.98 0.9],'fontsize',fontsize);  
end 
if 0 % ne
  hca = irf_panel('n');
  set(hca,'ColorOrder',mms_colors('12'))
...
if 0 % J FPI/FGM comparison ,y,z,1-3 panels
  for comp = ['x','y','z']
    npsmooth = 1;
    isub = isub + 1;
    zoomy = [zoomy isub];
    hca = irf_panel(['J ' comp ' fpi']);
    set(hca,'ColorOrder',mms_colors('12'))
    c_eval('irf_plot(hca,{gseJ?.(comp),gseJcurl.(comp)},''comp'');',ic)
    %c_eval('irf_plot(hca,{gseJ?.(comp).smooth(npsmooth),gseJcurl.(comp).smooth(npsmooth)},''comp'');',ic)
    %irf_legend(hca,{sprintf('N_{smooth} = %g',npsmooth)},[0.05 0.95],'fontsize',fontsize);
    hca.YLabel.String = {sprintf('J_%s',comp),'(nA/m^2)'};
    set(hca,'ColorOrder',mms_colors('12'))
    irf_legend(hca,{'FPI','FGM'},[0.98 0.95],'fontsize',fontsize);
...
if 0 % JxB x,  
  ...
  set(hca,'ColorOrder',pic_colors('123'))   
  c_eval('irf_plot(hca,{gseJxB?.x*scale,gseJyBz?*scale,gseJzBy?*scale},''comp'');',ic)
  hca.YLabel.String = {['J\times B_x'],['(' units_ ')']};
  set(hca,'ColorOrder',pic_colors('123'))
  %irf_legend(hca,{'JxB','-\nabla B^2/2\mu_0','-\mu_0^{-1}B\cdot\nabla B'}',[1.01 0.9],'fontsize',12);  
  irf_legend(hca,{'J\times B_x','J_yB_z','-Jz_B_y'}',[1.01 0.9],'fontsize',12);    
end
if 0 % JxB y,  
  isub = isub + 1;
  zoomy = [zoomy isub];      
  ...
  scale = 1e9*1e9; units_ = 'nT nAm^{-2}';
  set(hca,'ColorOrder',pic_colors('123'))   
  c_eval('irf_plot(hca,{gseJxB?.y*scale,gseJzBx?*scale,gseJxBz?*scale},''comp'');',ic)
  hca.YLabel.String = {['J\times B_y'],['(' units_ ')']};
  set(hca,'ColorOrder',pic_colors('123'))
  %irf_legend(hca,{'JxB','-\nabla B^2/2\mu_0','-\mu_0^{-1}B\cdot\nabla B'}',[1.01 0.9],'fontsize',12);  
  irf_legend(hca,{'J\times B_y','J_zB_x','-Jx_B_z'}',[1.01 0.9],'fontsize',12);    
end
if 0 % JxB z,  
  isub = isub + 1;
  zoomy = [zoomy isub];      
  ...
  scale = 1e9*1e9; units_ = 'nT nAm^{-2}';
  set(hca,'ColorOrder',pic_colors('123'))   
  c_eval('irf_plot(hca,{gseJxB?.z*scale,gseJxBy?*scale,gseJyBx?*scale},''comp'');',ic)
  hca.YLabel.String = {['J\times B_z'],['(' units_ ')']};
  set(hca,'ColorOrder',pic_colors('123'))
  %irf_legend(hca,{'JxB','-\nabla B^2/2\mu_0','-\mu_0^{-1}B\cdot\nabla B'}',[1.01 0.9],'fontsize',12);  
  irf_legend(hca,{'J\times B_z','J_xB_y','-Jy_B_x'}',[1.01 0.9],'fontsize',12);    
end
if 0 % JxB/ne x,  
  isub = isub + 1;
  zoomy = [zoomy isub];      
  hca = irf_panel('JxB/ne x');
  set(hca,'ColorOrder',pic_colors('123'))
  c_eval('irf_plot(hca,{gseJxBne?_mVm.x,gseJyBz?ne_mVm,gseJzBy?ne_mVm},''comp'');',ic)
  hca.YLabel.String = {['J\times B_x/ne'],['(mV/m)']};
  set(hca,'ColorOrder',pic_colors('123'))
  %irf_legend(hca,{'JxB','-\nabla B^2/2\mu_0','-\mu_0^{-1}B\cdot\nabla B'}',[1.01 0.9],'fontsize',12);  
  irf_legend(hca,{'J\times B_x/ne','J_yB_z/ne','-J_zB_y/ne'}',[1.01 0.9],'fontsize',12);    
end
if 0 % JxB/ne y,  
  isub = isub + 1;
  zoomy = [zoomy isub];      
  hca = irf_panel('JxB/ne y');  
  set(hca,'ColorOrder',pic_colors('123'))   
  c_eval('irf_plot(hca,{gseJxBne?_mVm.y,gseJzBx?ne_mVm,gseJxBz?ne_mVm},''comp'');',ic)
  hca.YLabel.String = {['J\times B_y/ne'],['(mV/m)']};
  set(hca,'ColorOrder',pic_colors('123'))
  %irf_legend(hca,{'JxB','-\nabla B^2/2\mu_0','-\mu_0^{-1}B\cdot\nabla B'}',[1.01 0.9],'fontsize',12);  
  irf_legend(hca,{'J\times B_y/ne','J_zB_x/ne','-J_xB_z/ne'}',[1.01 0.9],'fontsize',12);    
end
if 1 % JxB/ne z,  
  isub = isub + 1;
  zoomy = [zoomy isub];      
  ...
  scale = 1e9*1e9; units_ = 'nT nAm^{-2}';
  set(hca,'ColorOrder',pic_colors('123'))   
  c_eval('irf_plot(hca,{gseJxBne?_mVm.z,gseJxBy?ne_mVm,gseJyBx?ne_mVm},''comp'');',ic)
  hca.YLabel.String = {['J\times B_z/ne'],['(mV/m)']};
  set(hca,'ColorOrder',pic_colors('123'))
  %irf_legend(hca,{'JxB','-\nabla B^2/2\mu_0','-\mu_0^{-1}B\cdot\nabla B'}',[1.01 0.9],'fontsize',12);  
  irf_legend(hca,{'J\times B_z/ne','J_xB_y/ne','-J_yB_x/ne'}',[1.01 0.9],'fontsize',12);    
end
if 0 % JxB/ne x, curl
  isub = isub + 1;
  zoomy = [zoomy isub];      
  hca = irf_panel('JxB/ne x curl');
  set(hca,'ColorOrder',pic_colors('123'))  
  irf_plot(hca,{gseJxBne_mVm.x,gseJyBz_ne_mVm_curl,gseJzBy_ne_mVm_curl},'comp');
  hca.YLabel.String = {['J\times B_x/ne'],['(mV/m)']};
  set(hca,'ColorOrder',pic_colors('123'))
  %irf_legend(hca,{'JxB','-\nabla B^2/2\mu_0','-\mu_0^{-1}B\cdot\nabla B'}',[1.01 0.9],'fontsize',12);  
  irf_legend(hca,{'J\times B_x/ne','J_yB_z/ne','-J_zB_y/ne'}',[1.01 0.9],'fontsize',12);    
  irf_legend(hca,{'Curlometer'},[0.02 0.08],'color','k','fontsize',fontsize);  
end
if 0 % JxB/ne y, curl
  isub = isub + 1;
  zoomy = [zoomy isub];      
  hca = irf_panel('JxB/ne y curl');  
  set(hca,'ColorOrder',pic_colors('123'))   
  irf_plot(hca,{gseJxBne_mVm.y,gseJzBx_ne_mVm_curl,gseJxBz_ne_mVm_curl},'comp');
  hca.YLabel.String = {['J\times B_y/ne'],['(mV/m)']};
  set(hca,'ColorOrder',pic_colors('123'))
  %irf_legend(hca,{'JxB','-\nabla B^2/2\mu_0','-\mu_0^{-1}B\cdot\nabla B'}',[1.01 0.9],'fontsize',12);  
  irf_legend(hca,{'J\times B_y/ne','J_zB_x/ne','-J_xB_z/ne'}',[1.01 0.9],'fontsize',12);    
...
if 1 % JxB/ne z, curl
  isub = isub + 1;
  zoomy = [zoomy isub];      
  hca = irf_panel('JxB z curl');
  scale = 1e9*1e9; units_ = 'nT nAm^{-2}';
  set(hca,'ColorOrder',pic_colors('123'))     
  irf_plot(hca,{gseJxBne_mVm.z,gseJxBy_ne_mVm_curl,gseJyBx_ne_mVm_curl},'comp');
  hca.YLabel.String = {['J\times B_z/ne'],['(mV/m)']};
  set(hca,'ColorOrder',pic_colors('123'))
  %irf_legend(hca,{'JxB','-\nabla B^2/2\mu_0','-\mu_0^{-1}B\cdot\nabla B'}',[1.01 0.9],'fontsize',12);  
  irf_legend(hca,{'J\times B_z/ne','J_xB_y/ne','-J_yB_x/ne'}',[1.01 0.9],'fontsize',12);    
...
if 0 % JxB, 1 panels: LMN
  isub = isub + 1;
  zoomy = [zoomy isub];      
  hca = irf_panel('JxB gsm');
  scale = 1e9*1e9; units = 'nT nAm^{-2}';
  set(hca,'ColorOrder',pic_colors('matlab'))   
  irf_plot(hca,{gsmJxB.x*scale,gsmJxB.y*scale,gsmJxB.z*scale},'comp');      
  hca.YLabel.String = {['JxB (GSM)'],['(' units ')']};
  set(hca,'ColorOrder',pic_colors('matlab'))
  %irf_legend(hca,{'JxB','-\nabla B^2/2\mu_0','-\mu_0^{-1}B\cdot\nabla B'}',[1.01 0.9],'fontsize',12);  
  irf_legend(hca,{'x','y','z'}',[1.01 0.9],'fontsize',12);    
end
if 0 % JxB, contributions 1 panels: LMN 
  isub = isub + 1;
  zoomy = [zoomy isub];      
  hca = irf_panel('JxB lmn');
  scale = 1e9*1e9; units = 'nT nAm^{-2}';
...
npanels = 4;
%h = irf_plot(npanels);
[h,h2] = initialize_combined_plot(npanels,1,1,0.7,'vertical');
iisub = 0;
cmap = colormap(pic_colors('candy4'));
timeline = tint(1):0.5:tint(2);
doResample = 1;
...
dt1 = [0   -0.0359   -0.0558   -0.0140]*0;
if 0 % B gse abs
  isub = isub + 1;
  zoomy = [zoomy isub];
  hca = irf_panel('B abs gse');
  set(hca,'ColorOrder',mms_colors('1234'))  
  irf_plot(hca,{gseB1.abs,gseB2.abs,gseB3.abs,gseB4.abs},'comp','dt',dt1)
  hca.YLabel.String = {'B_{GSE}','(nT)'};
  set(hca,'ColorOrder',mms_colors('1234'))
  irf_legend(hca,{'1','2','3','4'},[0.98 0.9],'fontsize',fontsize);  
end 
if 0 % B gse
  isub = isub + 1;
  zoomy = [zoomy isub];
  hca = irf_panel('B x gse');
  set(hca,'ColorOrder',mms_colors('1234'))  
  irf_plot(hca,{gseB1.x,gseB2.x,gseB3.x,gseB4.x},'comp','dt',dt1)
  hca.YLabel.String = {'B_{x,GSE}','(nT)'};
  set(hca,'ColorOrder',mms_colors('1234'))
  irf_legend(hca,{'1','2','3','4'},[0.98 0.9],'fontsize',fontsize);  
end 
if 0 % B gse
  isub = isub + 1;
  zoomy = [zoomy isub];
  hca = irf_panel('B y gse');
  set(hca,'ColorOrder',mms_colors('1234'))  
  irf_plot(hca,{gseB1.y,gseB2.y,gseB3.y,gseB4.y},'comp','dt',dt1)
  hca.YLabel.String = {'B_{y,GSE}','(nT)'};
  set(hca,'ColorOrder',mms_colors('1234'))
  irf_legend(hca,{'1','2','3','4'},[0.98 0.9],'fontsize',fontsize);  
end 
if 0 % B gse
  isub = isub + 1;
  zoomy = [zoomy isub];
  hca = irf_panel('B z gse');
  set(hca,'ColorOrder',mms_colors('1234'))  
  irf_plot(hca,{gseB1.z,gseB2.z,gseB3.z,gseB4.z},'comp','dt',dt1)
  hca.YLabel.String = {'B_{z,GSE}','(nT)'};
  set(hca,'ColorOrder',mms_colors('1234'))
  irf_legend(hca,{'1','2','3','4'},[0.98 0.9],'fontsize',fontsize);  
end 
if 1 % B gse abs - B1
  ...
  hca = irf_panel('B abs gse');
  set(hca,'ColorOrder',mms_colors('1234'))  
  irf_plot(hca,{gseB1.abs-gseBav.abs.resample(gseB1),gseB2.abs-gseBav.abs.resample(gseB2),gseB3.abs-gseBav.abs.resample(gseB3),gseB4.abs-gseBav.abs.resample(gseB4)},'comp','dt',dt1)
  hca.YLabel.String = {'B_{GSE}-B_0','(nT)'};
  set(hca,'ColorOrder',mms_colors('1234'))
  irf_legend(hca,{'1','2','3','4'},[0.98 0.9],'fontsize',fontsize);  
end 
if 1 % B gse - B1
  ...
  hca = irf_panel('B x gse');
  set(hca,'ColorOrder',mms_colors('1234'))  
  irf_plot(hca,{gseB1.x-gseBav.x.resample(gseB1),gseB2-gseBav.x.resample(gseB2).x,gseB3.x-gseBav.x.resample(gseB3),gseB4.x-gseBav.x.resample(gseB4)},'comp','dt',dt1)
  hca.YLabel.String = {'B_{x,GSE}-B_0','(nT)'};
  set(hca,'ColorOrder',mms_colors('1234'))
  irf_legend(hca,{'1','2','3','4'},[0.98 0.9],'fontsize',fontsize);  
end 
if 1 % B gse - B1
  ...
  hca = irf_panel('B y gse');
  set(hca,'ColorOrder',mms_colors('1234'))  
  irf_plot(hca,{gseB1.y-gseBav.y.resample(gseB1),gseB2.y-gseBav.y.resample(gseB2),gseB3.y-gseBav.y.resample(gseB3),gseB4.y-gseBav.y.resample(gseB4)},'comp','dt',dt1)
  hca.YLabel.String = {'B_{y,GSE}-B_0','(nT)'};
  set(hca,'ColorOrder',mms_colors('1234'))
  irf_legend(hca,{'1','2','3','4'},[0.98 0.9],'fontsize',fontsize);  
end 
if 1 % B gse - B1
  ...
  hca = irf_panel('B z gse');
  set(hca,'ColorOrder',mms_colors('1234'))  
  irf_plot(hca,{gseB1.z-gseBav.z.resample(gseB1),gseB2.z-gseBav.z.resample(gseB2),gseB3.z-gseBav.z.resample(gseB3),gseB4.z-gseBav.z.resample(gseB4)},'comp','dt',dt1)
  hca.YLabel.String = {'B_{z,GSE}-B_0','(nT)'};
  set(hca,'ColorOrder',mms_colors('1234'))
  irf_legend(hca,{'1','2','3','4'},[0.98 0.9],'fontsize',fontsize);  
end 
if 0 % B gse dt
  isub = isub + 1;
  zoomy = [zoomy isub];
  hca = irf_panel('B gse dt');
  set(hca,'ColorOrder',mms_colors('1234'))  
  irf_plot(hca,{gseB1.abs,gseB2.abs,gseB3.abs,gseB4.abs},'comp','dt',dt)
  hca.YLabel.String = {'B_{GSE}','(nT)'};
  set(hca,'ColorOrder',mms_colors('1234'))
  irf_legend(hca,{'1','2','3','4'},[0.98 0.9],'fontsize',fontsize);  
end 
...
plot_sc_constellation(h2,gseR1.resample(tint_hall(1)),gseR2.resample(tint_hall(1)),gseR3.resample(tint_hall(1)),gseR4.resample(tint_hall(1)))

%% Electric field quality
tint_hall = irf.tint('2017-07-25T22:09:40.00Z/2017-07-25T22:10:00.00Z');
tint_hall = irf.tint('2017-07-25T22:09:40.00Z/2017-07-25T22:10:40.00Z');
...
if 1 % B dmpa
  ...
  set(hca,'ColorOrder',mms_colors('xyza'))  
  c_eval('irf_plot(hca,{dmpaB?.x,dmpaB?.y,dmpaB?.z},''comp'');',ic)
...
if 1 % B angle
  hca = irf_panel('B ang');
  c_eval('var = B?ang2.tlim(tint_hall);',ic)
  set(hca,'ColorOrder',mms_colors('xyza'))  
  hp1 = irf_patch(hca,{var,10},'smaller'); hp1.FaceColor = 'r'; hp1.EdgeColor = 'k';
  hold(hca,'on') 
  hp2 = irf_patch(hca,{var,10},'larger');  hp2.FaceColor = 'g'; hp2.EdgeColor = 'k';
  hold(hca,'off') 
  hca.YLabel.String = {'\theta','(deg)'};
  hca.YLabel.Interpreter = 'tex';
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'angle between B_{DMPA} and spin plane'},[0.98 0.9],'fontsize',fontsize,'color','k');  
end
if 0 % E dsl
  c_eval('var = dslE?;',ic)
  hca = irf_panel(var.name);
  set(hca,'ColorOrder',mms_colors('xyza'))  
  c_eval('irf_plot(hca,{dslE?.x,dslE?.y,dslE?.z},''comp'');',ic)
  hca.YLabel.String = {'E_{DSL}','(mV/m)'};
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'x','y','z'},[0.98 0.9],'fontsize',fontsize);    
  hl = irf_legend(hca,{var.userData.GlobalAttributes.Logical_source{1},var.name}',[0.05 0.98],'fontsize',fontsize,'color','k'); 
  c_eval('hl(?).Interpreter = ''none'';',1:numel(hl))  
end 
if 0 % E dsl
  c_eval('var = dslE?_l2pre_dce_edp;',ic)
  hca = irf_panel([var.name '__']);
  set(hca,'ColorOrder',mms_colors('xyza'))  
  irf_plot(hca,{var.x,var.y,var.z},'comp');
  hca.YLabel.String = {'E_{DSL}','(mV/m)'};
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'x','y','z'},[0.98 0.9],'fontsize',fontsize);      
  hl = irf_legend(hca,{var.userData.GlobalAttributes.Logical_source{1},var.name}',[0.05 0.98],'fontsize',fontsize,'color','k'); 
...
if 0 % E dslE?_l2pre_edp
  c_eval('var = dslE?_l2pre_dce2d_edp;',ic)
  hca = irf_panel(var.name);
  set(hca,'ColorOrder',mms_colors('xyza'))  
  irf_plot(hca,{var.x,var.y,var.z},'comp');
  hca.YLabel.String = {'E_{DSL}','(mV/m)'};
...
if 0 % E dslE?_l2pre_adp
  var = eval(sprintf('dslE%g_l2pre_%s_adp;',ic,mode));
  hca = irf_panel('E dslE?_l2pre_adp');
...
if 1 % E comparison of dsl z
  var1 = eval(sprintf('dslE%g_l2pre_%s_adp;',ic,mode));
  c_eval('var2 = dslE?_l2pre_dce2d_edp;',ic)
  c_eval('var3 = dslE?_l2pre_dce_edp;',ic)
  hca = irf_panel('comp adp edp');
  set(hca,'ColorOrder',mms_colors('123'))  
  irf_plot(hca,{var1,var2.z,var3.z},'comp');
  hca.YLabel.String = {'E_z','(mV/m)'};
  set(hca,'ColorOrder',mms_colors('123'))    
  hl = irf_legend(hca,{var1.userData.GlobalAttributes.Logical_source{1},var1.name}',[0.05 0.98],'fontsize',fontsize,'color',mms_colors('1')); 
  c_eval('hl(?).Interpreter = ''none'';',1:numel(hl))  
  hl = irf_legend(hca,{var2.userData.GlobalAttributes.Logical_source{1},var2.name}',[0.98 0.98],'fontsize',fontsize,'color',mms_colors('2')); 
  c_eval('hl(?).Interpreter = ''none'';',1:numel(hl))  
  hl = irf_legend(hca,{var3.userData.GlobalAttributes.Logical_source{1},var3.name}',[0.05 0.05],'fontsize',fontsize,'color',mms_colors('3')); 
  c_eval('hl(?).Interpreter = ''none'';',1:numel(hl))  
end 
if 0 % E comparison of dsl z, smoothed
  var1 = eval(sprintf('dslE%g_l2pre_%s_adp;',ic,mode));
  c_eval('var2 = dslE?_l2pre_dce2d_edp;',ic)
  c_eval('var3 = dslE?_l2pre_dce_edp;',ic)
  hca = irf_panel('comp adp edp smooth');
  set(hca,'ColorOrder',mms_colors('123'))    
  nsm = 301;
  irf_plot(hca,{var1.smooth(nsm),var2.z.smooth(nsm),var3.z.smooth(nsm)},'comp');
  hca.YLabel.String = {'E_z','(mV/m)'};
  set(hca,'ColorOrder',mms_colors('123'))    
  hl = irf_legend(hca,{var1.userData.GlobalAttributes.Logical_source{1},var1.name}',[0.05 0.98],'fontsize',fontsize,'color',mms_colors('1')); 
  c_eval('hl(?).Interpreter = ''none'';',1:numel(hl))  
...
if 0 % E dslE?_l2pre_quality
  var = eval(sprintf('dslE%g_l2pre_%s_quality;',ic,mode));
  %c_eval(['var = dslE?_l2pre_' mode '_quality;'],ic)
  hca = irf_panel(var.name);  
  set(hca,'ColorOrder',mms_colors('1'))  
  c_eval('irf_plot(hca,{dslE?_l2pre_quality});',ic)
  hca.YLabel.String = {'Quality',''};
  set(hca,'ColorOrder',mms_colors('1111'))  
  hl = irf_legend(hca,{var.userData.GlobalAttributes.Logical_source{1},var.name}',[0.05 0.98],'fontsize',fontsize,'color','k'); 
  c_eval('hl(?).Interpreter = ''none'';',1:numel(hl))  
end 
if 0 % E dslE?_l2pre_phase
  var = eval(sprintf('dslE%g_l2pre_%s_phase;',ic,mode));
  hca = irf_panel(var.name);
  set(hca,'ColorOrder',mms_colors('1'))  
  irf_plot(hca,{var});
...
if 0 % E dslE?_l2pre_dce2d_adc_offset
  c_eval('var = dslE?_l2pre_dce2d_adc_offset;',ic)
  hca = irf_panel(var.name);
  set(hca,'ColorOrder',mms_colors('xy'))  
  irf_plot(hca,{var});
  hca.YLabel.String = {'adc','offset'};
  set(hca,'ColorOrder',mms_colors('xy'))    
  irf_legend(hca,{'x','y'},[0.98 0.9],'fontsize',fontsize); 
  set(hca,'ColorOrder',mms_colors('111'))    
  hl = irf_legend(hca,{var.userData.GlobalAttributes.Logical_source{1},var.name}',[0.05 0.98],'fontsize',fontsize,'color','k'); 
  c_eval('hl(?).Interpreter = ''none'';',1:numel(hl))  
end 
if 0 % E dslE?_l2pre_edp_swwake_residue
  c_eval('var = dslE?_l2pre_edp_swwake_residue;',ic)
  hca = irf_panel(var.name);
  set(hca,'ColorOrder',mms_colors('1'))  
  irf_plot(hca,{var});
  hca.YLabel.String = {'swwake','residue'};
  set(hca,'ColorOrder',mms_colors('111'))    
  hl = irf_legend(hca,{var.userData.GlobalAttributes.Logical_source{1},var.name}',[0.05 0.98],'fontsize',fontsize,'color','k'); 
  c_eval('hl(?).Interpreter = ''none'';',1:numel(hl))  
end 
if 0 % E dslE?_l2pre_spin_residue
  c_eval('var = dslE?_l2pre_spin_residue;',ic)
  hca = irf_panel(var.name);
  set(hca,'ColorOrder',mms_colors('xyz'))  
  irf_plot(hca,{var.x,var.y,var.z},'comp');
  hca.YLabel.String = {'spin','residue'};
  set(hca,'ColorOrder',mms_colors('xyz'))    
  irf_legend(hca,{'x','y','z'},[0.98 0.9],'fontsize',fontsize); 
  set(hca,'ColorOrder',mms_colors('1111'))    
  hl = irf_legend(hca,{var.userData.GlobalAttributes.Logical_source{1},var.name}',[0.05 0.98],'fontsize',fontsize,'color','k'); 
