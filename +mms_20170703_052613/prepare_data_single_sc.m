...
elseif 1
  %%
  ictmp = ic;  
  c_eval('ePitch? = ePDist?.pitchangles(dmpaB?,15);',ictmp)
  c_eval('ePitch?par = ePDist?.pitchangles(dmpaB?,[0 15]);',ictmp)
  c_eval('ePitch?perp = ePDist?.pitchangles(dmpaB?,[75 105]);',ictmp)
  c_eval('ePitch?apar = ePDist?.pitchangles(dmpaB?,[165 180]);',ictmp)
