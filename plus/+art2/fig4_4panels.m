...
set(gcf,'position',[10   684   591   195]);
h = irf_plot(nPanels);
set(h(1),'position',[0.1300    0.59    0.7750    0.35]);
set(h(2),'position',[0.1300    0.2400    0.7750    0.35])
% d
isub = 1;
...
if 1 % Parallel electric field
    hca = h(isub); isub = isub + 1;  
    irf_plot(hca,Eper3,'color',[0.2 0.5 0.2]); hold on;
    irf_plot(hca,Eper4,'color','b'); hold off;
