function plot_vec(A,B,velocity,position,scale)  
% plot_vec(A,B,velocity,position,scale)   
%   
%   plots vector in 3plot 
%   A, B in FAC system

%% Make time scale to length scale
A(:,1)=A*v; % x column is km now
B(:,1)=B*v; % x column is km now
