...
Tints = irf.tint('2017-07-06T08:16:38.30Z/2017-07-06T08:16:39.10Z');
tint_fred = irf.tint('2017-07-06T08:16:37.00Z/2017-07-06T08:16:43.00Z');
...
if 0 
  ...
  Tints = Tints +2*[-1 1];
tic
[xvecs_gse,yvecs_gse,Power_gse] = mms.fk_powerspec4SC('gseE?par.tlim(Tints)','gseR?','gseB?',Tints_tmp,'linear',10,'numk',400,'numf',200,'cav',4,'wwidth',2);
[xvecs_perp1,yvecs_perp1,Power_perp1] = mms.fk_powerspec4SC('facE?.tlim(Tints).x','facR?','facB?',Tints_tmp,'linear',10,'numk',400,'numf',200,'cav',4,'wwidth',2);
[xvecs_perp2,yvecs_perp2,Power_perp2] = mms.fk_powerspec4SC('facE?.tlim(Tints).y','facR?','facB?',Tints_tmp,'linear',10,'numk',400,'numf',200,'cav',4,'wwidth',2);
[xvecs_par,yvecs_par,Power_par] = mms.fk_powerspec4SC('facE?.tlim(Tints).z','facR?','facB?',Tints_tmp,'linear',10,'numk',400,'numf',200,'cav',4,'wwidth',2);
toc
Tints = Tints_tmp;
end
