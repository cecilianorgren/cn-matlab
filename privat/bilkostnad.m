...
%%
distance_travelled_10km = linspace(0,8000,100);
d = distance_travelled_10km;
gas_price_per_L = 25; % sek

cost_ = @(car_price,gas_consumption) car_price + gas_consumption*distance_travelled_10km*gas_price_per_L;
cost = @(car) car.price + car.gas_per_10km*distance_travelled_10km*gas_price_per_L;

car(1).price = 30000-15000; % buy - sell
car(1).gas_per_10km = 0.7*1.2; % multiplication factor can be used to simulate higher maintenance costs
...
hca = subplot(1,1,1);
plot(hca,d,cost(car(1)),d,cost(car(2)))
