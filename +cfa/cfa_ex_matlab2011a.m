...
disp('== Download:')
urlDownloadLine='http://cfadev.esac.esa.int/cfa/aio/product-action?&USERNAMENON_BROWSER&DATASET_ID=C3_CP_ASP_IONC&START_DATE=2004-06-18T11:35:00Z&END_DATE=2004-06-19T18:35:00Z';
...
Data = urlread(URL, 'Authentication', 'Basic','Get',...
    { 'Username', 'avaivads', 'password', '!kjUY88lm',...
    'DATASET_ID', 'C3_CP_ASP_IONC',...
    'START_DATE', '2004-06-18T11:35:00Z',...
    'END_DATE', '2004-06-19T18:35:00Z', 'NON_BROWSER', '1'});
%%
urlDownloadLine='http://cfadev.esac.esa.int/cfa/aio/product-action?&Username=avaivads&password=!kjUY88lm&NON_BROWSER&DATASET_ID=C3_CP_ASP_IONC&START_DATE=2004-06-18T11:35:00Z&END_DATE=2004-06-19T18:35:00Z';
[loginMsg,loginStatus]=urlread(urlDownloadLine,'get')

%% Arnauds ex, rework
URL = 'http://cfadev.esac.esa.int/cfa/aio/product-action';
Data = urlread(URL, 'Get',...
    {'DATASET_ID', 'C3_CP_ASP_IONC',...
    'START_DATE', '2004-06-18T11:35:00Z',...
    'END_DATE', '2004-06-19T18:35:00Z', 'NON_BROWSER', '1'},...
    'Authentication', 'Basic',{'USERNAME', 'avaivads', 'PASSWORD', '!kjUY88lm'});