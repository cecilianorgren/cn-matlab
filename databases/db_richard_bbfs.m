...
time = ncread('/Users/cno062/Data/MMS/Richard_DB/mms_b_gsm_2017-2021.nc','time');
vec_tot = ncread('/Users/cno062/Data/MMS/Richard_DB/mms_b_gsm_2017-2021.nc','represent_vec_tot');
xarray = ncread('/Users/cno062/Data/MMS/Richard_DB/mms_b_gsm_2017-2021.nc','__xarray_dataarray_variable__');
...
units = irf_units;
path_nc_bffs = '/Users/cno062/Data/MMS/Richard_DB/mms_bbfsdb_2017-2021.nc';
finfo = ncinfo(path_nc_bffs);

varstrs = {finfo.Variables.Name};
...
%%
path_nc_r_gsm = '/Users/cno062/Data/MMS/Richard_DB/mms_r_gsm_betai_2017-2021.nc';
finfo = ncinfo(path_nc_r_gsm);
varstrs = {finfo.Variables.Name};
for ivar = 1:numel(varstrs)
  varstr = varstrs{ivar};
