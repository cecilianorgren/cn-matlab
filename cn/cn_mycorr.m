function [ t0, dt, tplus, tminus, corr ] = cn_mycorr( data1, data2, window, fs, err )
...
ii = find(corr == min(corr(1+OFF:end-OFF)));
...
% Take instead 1.01 times

corr_plus = corr - err*corr_min;
