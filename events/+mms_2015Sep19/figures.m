...
ic = 1;
tint = irf.tint('2015-09-19T09:09:30.00Z/2015-09-19T09:10:30.00Z');
%TSTART = tic; mms_survey.load_data_overview; toc(TSTART);


%% Figure 1: 1 sc overview 
ic = 3;
%tintZoom = irf.tint('2015-09-19T09:09:56.20Z/2015-09-19T09:09:59.40Z');
tintZoom3 = irf.tint('2015-09-19T09:09:56.10Z/2015-09-19T09:09:59.50Z');
tintZoom4 = irf.tint('2015-09-19T09:09:56.70Z/2015-09-19T09:09:59.90Z');
tint = irf.tint('2015-09-19T09:09:30.00Z/2015-09-19T09:10:30.00Z');
c_eval('tintZoom = tintZoom?;',ic)
npanels = 11;
cmap = 'jet';
...
if 1 % Ohm's law x
  ...
  if 0
    irf_plot(hca,{gseAvE.resample(gseOhmGradPe).x,gseOhmGradPe.x,-gseOhmVexB.x,-gseOhmVixB.x,gseOhmJxB.x,gseAvE.x+gseOhmVexB.resample(gseAvE).x+gseOhmGradPe.resample(gseAvE).x},'comp');
    set(hca,'ColorOrder',mms_colors('1234ba'))
  elseif resampleE
    irf_plot(hca,{gseAvE.resample(gseOhmGradPe).x,gseOhmGradPe.x,-gseOhmVexB.x,-gseOhmVixB.x,gseOhmJxB.x},'comp');
    set(hca,'ColorOrder',mms_colors('1234ba'))
  else
    irf_plot(hca,{gseAvE.x,gseOhmGradPe.x,-gseOhmVexB.x,-gseOhmVixB.x,gseOhmJxB.x},'comp');
    set(hca,'ColorOrder',mms_colors('1234ba'))    
  end
    irf_legend(hca,{'E','\nabla P_e','-v_e\times B','-v_i\times B','J\times B/ne'},[0.05 0.1],'fontsize',12);
...
if 1 % Ohm's law y
  ...
  set(hca,'ColorOrder',mms_colors('1234b'))
  if resampleE
    irf_plot(hca,{gseAvE.resample(gseOhmGradPe).y,gseOhmGradPe.y,-gseOhmVexB.y,-gseOhmVixB.y,gseOhmJxB.y},'comp');
  else
...
if 1 % Ohm's law z
  ...
  set(hca,'ColorOrder',mms_colors('1234b'))
  if resampleE    
    irf_plot(hca,{gseAvE.resample(gseOhmGradPe).z,gseOhmGradPe.z,-gseOhmVexB.z,-gseOhmVixB.z,gseOhmJxB.z},'comp');
  else
...
if 1 % Ohm's law residual 3 components
  ...
  set(hca,'ColorOrder',mms_colors('xyz'))
  if resampleE
    residual = gseAvE.resample(gseOhmGradPe)+gseOhmVexB.resample(gseOhmGradPe)+gseOhmGradPe.resample(gseOhmGradPe);
  else
...
hca = irf_panel('E'); hca.YLim = [-10 10];
irf_plot_axis_align
...
time = irf_time('2015-09-19T09:09:58.50Z','utc>epochtt');%+-1*0.03;%+0.2+0*0.03;
...
if 1 % EdotJ par
  ...
  set(hca,'ColorOrder',mms_colors('1234'))
  c_eval('irf_plot(hca,{EdotJ?par,EdotJ?perp,EdotJ?par+EdotJ?perp,RedotJ?},''comp'');',ic)
  hca.YLabel.String = {'E\cdotJ','(nW/m^3)'};
  set(hca,'ColorOrder',mms_colors('1234'))    
  irf_legend(hca,{'||','\perp','||+\perp','(E+v_exB). J'},[0.98 0.9],'fontsize',12);
end
if 0 % Q
  hca = irf_panel('Q');
  set(hca,'ColorOrder',mms_colors('1234'))
...
irf_zoom(h1,'x',tintZoom)
irf_zoom(h1([1:4 6:8]),'y')
hca = irf_panel('E par'); hca.YLim = [-10 10];
hca = irf_panel('E'); hca.YLim = [-10 10];
irf_plot_axis_align
h1(1).Title.String = irf_ssub('MMS ?',ic);
...
%% Figure: eletron pa plots, gse fields
npanels = 10;
tintZoom2 = irf.tint('2015-09-19T09:09:56.10Z/2015-09-19T09:09:59.50Z');
tintZoom3 = irf.tint('2015-09-19T09:09:56.10Z/2015-09-19T09:09:59.50Z');
tintZoom4 = irf.tint('2015-09-19T09:09:56.70Z/2015-09-19T09:09:59.90Z');
tint = irf.tint('2015-09-19T09:09:30.00Z/2015-09-19T09:10:30.00Z');
c_eval('tintZoom = tintZoom?;',ic)
...
%% Plot perpendicular ve vi and E
% Initialize figure
%[h1,h2] = initialize_combined_plot(8,2,2,0.4,'vertical');
h1 = irf_plot(10);
cmap = 'jet';
ic = 4;
tintZoom1 = irf.tint('2015-09-19T09:09:56.10Z/2015-09-19T09:09:59.50Z');
tintZoom2 = irf.tint('2015-09-19T09:09:56.10Z/2015-09-19T09:09:59.50Z');
tintZoom3 = irf.tint('2015-09-19T09:09:56.10Z/2015-09-19T09:09:59.50Z');
tintZoom4 = irf.tint('2015-09-19T09:09:56.70Z/2015-09-19T09:09:59.90Z');
tintZoom4 = irf.tint('2015-09-19T09:09:56.10Z/2015-09-19T09:09:59.50Z');
tint = irf.tint('2015-09-19T09:09:30.00Z/2015-09-19T09:10:30.00Z');
c_eval('tintZoom = tintZoom?;',ic)
...
if 1 % V ExB
  hca = irf_panel('V ExB');
  set(hca,'ColorOrder',mms_colors('xyza'))
  %c_eval('irf_plot(hca,{gseVExB?.x.tlim(tint),gseVExB?.y.tlim(tint),gseVExB?.z.tlim(tint),gseVExB?.abs.tlim(tint)},''comp'');',ic)
  c_eval('irf_plot(hca,{gseVExB?.resample(gseVe?).x.tlim(tint),gseVExB?.resample(gseVe?).y.tlim(tint),gseVExB?.resample(gseVe?).z.tlim(tint)},''comp'');',ic)
  %c_eval('irf_plot(hca,{gseVe?.x.tlim(tint),gseVe?.y.tlim(tint),gseVe?.z.tlim(tint)},''comp'');',ic)  
  hca.YLabel.String = {'v_{ExB}','(nT)'};
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'x','y','z'},[0.98 0.9],'fontsize',12);  
  %hca.YLim = [-1200 700];  
end
...
if 1 % V perp x
  hca = irf_panel('V perp x');
  set(hca,'ColorOrder',mms_colors('xyza'))
  c_eval('irf_plot(hca,{gseVi?perp.x.tlim(tint),gseVe?perp.x.tlim(tint),gseVExB?.resample(gseVe?).x.tlim(tint)},''comp'');',ic)
  hca.YLabel.String = {'v_{\perp}','(km/s)'};
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'v_i','v_{e}','v_{ExB}'},[0.98 0.9],'fontsize',12);  
  ylabel(hca,{'v_{\perp,x}','(km/s)'},'interpreter','tex');
end
if 1 % V perp y
  hca = irf_panel('V perp y');
  set(hca,'ColorOrder',mms_colors('xyza'))
  c_eval('irf_plot(hca,{gseVi?perp.y.tlim(tint),gseVe?perp.y.tlim(tint),gseVExB?.resample(gseVe?).y.tlim(tint)},''comp'');',ic)
  hca.YLabel.String = {'v_{\perp}','(km/s)'};
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'v_i','v_{e}','v_{ExB}'},[0.98 0.9],'fontsize',12);  
  ylabel(hca,{'v_{\perp,y}','(km/s)'},'interpreter','tex');
end
if 1 % V perp z
  hca = irf_panel('V perp z');
  set(hca,'ColorOrder',mms_colors('xyza'))
  c_eval('irf_plot(hca,{gseVi?perp.z.tlim(tint),gseVe?perp.z.tlim(tint),gseVExB?.resample(gseVe?).z.tlim(tint)},''comp'');',ic)
  hca.YLabel.String = {'v_{\perp}','(km/s)'};
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'v_i','v_{e}','v_{ExB}'},[0.98 0.9],'fontsize',12);  
  ylabel(hca,{'v_{\perp,z}','(km/s)'},'interpreter','tex');
end
