ic = 1;
tint = irf.tint('2017-07-09T17:14:53.00Z/2017-07-09T17:42:33.00Z');
%tint = irf.tint('2017-07-06T00:54:03.00Z/2017-07-06T09:56:03.00Z');
...
dirName = '2017-07-09_17';%sprintf('%s-%s-%s_%s',numName(1:4),numName(5:6),numName(7:8),numName(9:14));
dirNameMatlab = '+mms_20170709_17';%sprintf('+mms_%s%s%s_%s',numName(1:4),numName(5:6),numName(7:8),numName(9:14));
