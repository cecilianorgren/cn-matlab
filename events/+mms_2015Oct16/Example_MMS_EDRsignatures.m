...
c_eval('Exyzf? = dslE?brst;',ic)

toc;

%% Load electron particle data
c_eval('tmpDataObj? = dataobj(''/Volumes/Nexus/data/mms?/fpi/brst/l1b/des-dist/2015/10/16/mms?_fpi_brst_l1b_des-dist_20151016103254_v1.1.0.cdf'');',ic);
