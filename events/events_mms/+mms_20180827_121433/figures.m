...
tintZoom = irf.tint('2017-07-09T17:15:40.00Z',40);
eint = [000 40000];
vint = [-Inf Inf];
...
if 1 % Ve abs
  isub = isub + 1;
  zoomy = [zoomy isub];
  hca = irf_panel('Ve abs');
  set(hca,'ColorOrder',mms_colors('xyza'))
  c_eval('irf_plot(hca,{gseVe?.abs},''comp'');',ic)  
  hca.YLabel.String = {'v_e','(km/s)'};
  set(hca,'ColorOrder',mms_colors('xyza'))
  irf_legend(hca,{'||'},[0.98 0.9],'fontsize',12);
  hca.YLim = [00000 30000];
end
if 1 % Ve
  isub = isub + 1;
  zoomy = [zoomy isub];
