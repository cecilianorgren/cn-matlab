tint = irf.tint('2015-10-16T06:00:00',1);
sc=1:4;
...
c_eval('dfg? = dfg?.resample(dfg1);',sc)
%% Plot and compare
tint_zoom = [edp2.time.start.epochUnix edp2.time.stop.epochUnix];
tint_zoom = irf.tint('2015-10-16T06:00:00',8*60*60);
h = irf_plot({dfg1,edp1,dfg2,edp2,dfg3,edp3,dfg4,edp});
