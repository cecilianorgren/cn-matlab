...
c_eval('objDesDist? = dataobj([db_info.local_file_db_root ''/mms?/fpi/brst/l2/des-dist/2015/10/16/mms?_fpi_brst_l2_des-dist_20151016103254_v2.1.0.cdf'']);',ic);
c_eval('objDesMoms? = dataobj([db_info.local_file_db_root ''/mms?/fpi/brst/l2/des-moms/2015/10/16/mms?_fpi_brst_l2_des-moms_20151016103254_v2.1.0.cdf'']);',[2]);
end
...
c_eval('tic; E?err=mms.db_get_ts(''mms?_edp_brst_l2_dce'',''mms?_edp_dce_err_brst_l2'',tint); toc',ic);
