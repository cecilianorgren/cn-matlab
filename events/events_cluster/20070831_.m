...
tint=[toepoch([2007 9 26 10 50 0]) toepoch([2007 9 26 11 0 0])];

%% Loading data
cd /home/cecilia/data/20070926/
caa_load
%% Loading E and B
% E1 and B1 not available
...
[caaE2,~,E2]=c_caa_var_get('E_Vec_xyz_ISR2__C2_CP_EFW_L2_E3D_INERT');
...
E3fft=caa_powerfft(E3,256,fs,overlap);
E4fft=caa_powerfft(E4,256,fs,overlap);

%% Getting frequency spectrum with overlap
overlap=50;
%E2fft_olap=caa_powerfft(E2,1024,450,overlap);
E3fft_olap=caa_powerfft(E3,256,fs,overlap);
E4fft_olap=caa_powerfft(E4,256,fs,overlap);
