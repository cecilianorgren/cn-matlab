ic = 2:4;
tint = irf.tint('2015-11-12T06:05:00.00Z/2015-11-12T07:55:00.00Z'); %20151112071854
if 1
if 0
...
tintB = irf.tint('2015-11-12T06:00:00.00Z/2015-11-12T10:00:00.00Z'); %20151112071854

c_eval('tic; dmpaB?srvy=mms.db_get_ts(''mms?_fgm_srvy_l2'',''mms?_fgm_b_dmpa_srvy_l2'',tintB); toc;',ic);
c_eval('tic; gseB?srvy=mms.db_get_ts(''mms?_fgm_srvy_l2'',''mms?_fgm_b_gse_srvy_l2'',tintB); toc;',ic);
c_eval('tic; gsmB?srvy=mms.db_get_ts(''mms?_fgm_srvy_l2'',''mms?_fgm_b_gsm_srvy_l2'',tintB); toc;',ic);
