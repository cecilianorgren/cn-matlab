...
tint_outflow = toepoch([2008 04 22 17 36 35; 2008 04 22 17 37 20])';
tint_highbeta = toepoch([2008 04 22 17 37 00; 2008 04 22 17 37 20])';
tint_lowbeta = toepoch([2008 04 22 17 36 35; 2008 04 22 17 37 00])';
tint_ov = toepoch([2008 04 22 17 36 35; 2008 04 22 17 37 20])';
em_tint = toepoch([2008 04 22 17 37 12.0;2008 04 22 17 37 13.0])';
es_tint = toepoch([2008 04 22 17 36 45.2;2008 04 22 17 36 46.1])';


tint = em_tint;
tint_fft = tint_highbeta;%tint_ov_thinner2;    
...
%tint = toepoch([2008 04 22 18 07 33; 2008 04 22 18 07 36.9])';
   ...
   %hca.YLabel.String = 'Power Spectral Density [V^2 /Hz]';
    ...
    hca.Title.String = ['Cluster ' num2str(sc) ': '  tint_str];
    hca.XLim = [3e-4 1e1];
    hca.YLim = [1e-6 1e8];
    tickstep = 1;
    ...
    irf_legend(hca,['C = ' num2str(corr_dir(i_dir),'%.2f') ',  v = ' num2str(velocity,'%.0f') ' x [' num2str(direction,'%.2f') '] km/s'],[0.05 0.95])
