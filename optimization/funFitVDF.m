...
for iTime = 1:nTimes
  ...
  % better use last index of f_final_separate to index population or switch
  % dimension here for a quick fix...
  f_final_separate = permute(f_final_separate,[2 3 1]);
