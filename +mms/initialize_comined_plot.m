...
% MMS.INITIALIZE_COMBINED_PLOT - Combination of irf time panels and subplot(nRows,nCols,i_subplot).
%
%   [h1,h2] = mms.INITIALIZE_COMBINED_PLOT(nTimePanels,nRows,nCols,totCols OR timeseriesFraction,sorting);
%     Input:
...
%
%   Examples: 
%     mms.INITIALIZE_COMBINED_PLOT(8,2,2,0.4,'vertical')
%     mms.INITIALIZE_COMBINED_PLOT(8,2,2,3,'vertical')
...
else % gives the the "total number of columns"
  for ii = 1:nTimePanels, % move timeseries panels
    space = 1-(nCols + 1)/(totCols);
