...
FID = fopen('mms4_scb_20150828_150600t.dat');
Bscmt = fread(FID,tsl,'int64');
Bscmt = int64(Bscmt);
Bscmt =  EpochTT(Bscmt);

FID = fopen('mms4_scb_20150828_150600Bxyz.dat');
...
tmpDataObj = dataobj('data/mms4_edp_brst_ql_dce2d_20150828150624_v0.2.0.cdf');
